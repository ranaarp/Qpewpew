...
int p1_jump_button = 0; 
int p1_jump_button_prev = 0; 
int p1_shoot_button = 0; 
int p1_shoot_button_prev = 0; 
int p1_gate_button = 0; 
int p1_gate_button_prev = 0; 
...
int p2_jump_button = 0; 
int p2_jump_button_prev = 0; 
int p2_shoot_button = 0; 
int p2_shoot_button_prev = 0; 
int p2_gate_button = 0; 
int p2_gate_button_prev = 0; 
...
player p1 = {1, 20, 40 - player_height, 0, 0, 1, 0, 20, 100, 1, 0, 0, 128, 64, 0, 0, 0}; // reason for 60 - player height is cause the box takes up 4 pixels from the total of 64 
player p2 = {2, 40, 60 - player_height, 0, 0, 1, 0, 20, 100, 1, 0, 0, 128, 64, 0, 0, 0}; 
...
if((*p).player_number == 1){
    if(p1_shoot_button != p1_shoot_button_prev && p1_shoot_button == 0){
      (*p).bullet_x = (*p).x + 4; 
      (*p).bullet_y = (*p).y + 4;
      (*p).bullet_vx = 1; // gotta change this 
      (*p).bullet_vy = -1 * (*p).up;
